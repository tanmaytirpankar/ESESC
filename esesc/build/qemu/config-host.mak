...
all:
prefix=/home/ESESC/esesc/build/qemu
bindir=${prefix}/bin
libdir=${prefix}/lib
...
libs_softmmu= -lutil -lncurses -ltinfo   
ARCH=x86_64
STRIP=strip
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.5.0
PKGVERSION=
SRC_PATH=/home/ESESC/esesc/emul/qemu
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/ESESC/esesc/build/qemu/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
