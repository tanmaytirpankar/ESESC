...
#ifdef CONFIG_ESESC
    cpu->fid = QEMUReader_resumeThread(cpu->host_tid, UINT32_MAX);
#endif
...
#define IMPLEMENT_EPOLL_PWAIT
    ...
    case TARGET_NR_signal_simu:
        ret = QEMUReader_signal_simu(cpu->fid, arg1, arg2, arg3);
        break;

    case TARGET_NR_signal_qemu:
        ret = QEMUReader_signal_qemu(cpu->fid, arg1, arg2, arg3, arg4);
        break;
