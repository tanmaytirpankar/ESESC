...
///MnB:~ Memory Data
        ...
        //QEMUReader_queue_inst(0, live_warmup_addr[i], 0, iSALU_ST, LREG_R0, LREG_R0, LREG_InvalidOutput, NULL, NULL, NULL);
      } else {
        QEMUReader_queue_inst(0, live_warmup_addr[i], 0, iLALU_LD, LREG_R0, LREG_R0, LREG_InvalidOutput, NULL);
        //QEMUReader_queue_inst(0, live_warmup_addr[i], 0, iLALU_LD, LREG_R0, LREG_R0, LREG_InvalidOutput, NULL, NULL, NULL);
///:.
      }
    }
  }
